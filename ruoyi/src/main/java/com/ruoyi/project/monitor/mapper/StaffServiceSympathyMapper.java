...
public interface StaffServiceSympathyMapper<integer> {
    ...
    public int StaffServiceSympathyCount(@Param("expenseOrgId") int expenseOrgId, @Param("orgId") int orgId, @Param("createdUserOrg") int createdUserOrg, @Param("submitStatus") Integer submitStatus, @Param("status") Integer status, @Param("sons") List<Integer> sons);
    public List<StaffServiceSympathy> StaffServiceSympathySearch(@Param("expenseOrgId") int expenseOrgId, @Param("orgId") int orgId, @Param("createdUserOrg") int createdUserOrg, @Param("submitStatus") Integer submitStatus, @Param("status") Integer status, @Param("sons") List<Integer> sons);
